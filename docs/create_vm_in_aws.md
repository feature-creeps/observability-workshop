...
3. An AMI (Amazon Machine Instance) 
    - AMI's are region dependent. For the purposes of this tutorial we have used Ubuntu 
    - machine type `m5.2xlarge` is what is used here 
...
2. Create a running instance of type `m5.2xlarge` using docker-machine. 
